...
const val STROKE_WITH = 10f
const val CENTRE_RADIUS = 40f
...
open class CustomImageView : AppCompatImageView {
    ...
    constructor(context: Context?, attrs: AttributeSet?) : super(
        ...
        CustomLogger.d("constructor called...")
//        this.setBackgroundResource(R.drawable.border_imageview)
    }
    ...
    fun loadImageWithUrl(imageUrl: String?) {
        ...
        val cpdImageLoader = CircularProgressDrawable(context).apply {
            ...
            setColorSchemeColors(ContextCompat.getColor(context, R.color.colorProgress))
            start()
        }
